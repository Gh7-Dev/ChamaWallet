...
import { sanitizeIdentifier, toPascalCase, toCamelCase } from './utils.js';
...
export * from "./types.js";`);
  ...
  eventDiagnostics(typeGenerator, clientGenerator) {
    ...
    return events.flatMap((event, eventIndex) => {
      ...
      const interfaceRenamed = interfaceNames[eventIndex] !== `${toPascalCase(sanitized)}Event`;
      const filterMethodRenamed = filterMethodNames[eventIndex] !== `${toCamelCase(sanitized)}EventFilter`;
