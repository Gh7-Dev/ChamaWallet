...
function contractSpecTypeName(td) {
  if (td.switch().value === curr_generated.default.ScSpecType.scSpecTypeUdt().value) {
...
class RpcServer {
  ...
  async getContractWasmByContractId(contractId) {
    ...
    if (instance.executable().switch() === curr_generated.default.ContractExecutableType.contractExecutableStellarAsset()) {
      return Promise.reject({
        code: 400,
