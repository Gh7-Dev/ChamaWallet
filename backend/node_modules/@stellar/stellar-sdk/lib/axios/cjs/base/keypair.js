...
const MESSAGE_PREFIX = buffer.Buffer.from("Stellar Signed Message:\n", "utf8");
class Keypair {
  type;
  _publicKey;
  _secretSeed;
  ...
  _hashMessage(message) {
    const messageBytes = typeof message === "string" ? buffer.Buffer.from(message, "utf8") : message;
    return hashing.hash(buffer.Buffer.concat([MESSAGE_PREFIX, messageBytes]));
  }
  /**
